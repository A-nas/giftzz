<?php
require_once("connect.php"); // include the library file
define('EMAIL_ADD', 'giftzz2015@hotmail.com'); // define any notification email
define('PAYPAL_EMAIL_ADD', 'giftzzadmin@hotmail.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
