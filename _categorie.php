...
?>
<?php
$getcat=$_GET['CODE_CAT'];
?>
<?php
$art="select * from article where CODE_CAT = ".$getcat;
$redart=mysql_query($art);
?>
<?php
$scat="select * from sous_categorie where CODE_CAT =".$getcat;
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#" class="active">boutique<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.php?id=<?php echo $getcat ?>" >produits détails</a></li> 
						...
						<div class="MARQUES_products">
							<div class="MARQUES-name">
								<ul class="nav nav-pills nav-stacked">
									<li><a href="sous_categorie.php?COD_S_CAT=<?php echo $lire['COD_S_CAT'];?>"> +  <?php echo $lire['NOM_S_CAT'];?></a></li>
								</ul>
							</div>
						</div>
						<?php }?>
