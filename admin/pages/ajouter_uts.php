...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajouter des utilisateur</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Ajouter les informations sur un utilisateur
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action ="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
										...
										<div class="form-group">
                                            ...
                                            <input name="apre" class="form-control">
                                        </div>
										<div class="form-group">
                                            <label>MOT DE PASS utilisateur</label>
                                            <input  type="password" name="apaw" class="form-control">
                                        </div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input name="apsd" class="form-control">
                                        </div>
									...
									$type=$_POST['atype'];
									$apse=$_POST['apsd'];
									$sql=mysql_query("insert into utilisateur values('$email','$nom','$pre','$pass','','','','','','','','$type','$apse','','1','1')");
