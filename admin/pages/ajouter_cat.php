...
<body>
    <div id="wrapper">
			 ...
			 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="tables.html"><i class="fa fa-dashboard fa-fw"></i> attacher des articles</a>
                        </li>
						<li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i>  lier des articles</a>
                        </li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ajouter des Categories</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action ="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
										...
										<div class="form-group">
                                            <label>LIBELLE Categorie</label>
                                            <input name="clib" class="form-control">
                                        </div>
									...
									$code=$_POST['ccode'];
									$lib=$_POST['clib'];
									$sql=mysql_query("insert into Categorie values('$code','$lib')");
