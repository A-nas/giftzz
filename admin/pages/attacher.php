...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">attacher des articles a des evenements </h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									$code=$_POST['acode'];
									$nom=$_POST['anom'];
									$sql=mysql_query("insert into attacher values('$code','$nom')");
									if($sql){echo "bien attacher";}else{echo "non attacher";}
									}
									?>
                                </div>
                            </div>
