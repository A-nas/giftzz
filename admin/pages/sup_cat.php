...
<body>
    <div id="wrapper">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="ajouter_cat.php">Ajouter des Evenement</a>
                                </li>
                                <li>
                                    <a href="sup_cat.php">Supprimer des Evenement</a>
                                </li>
                            </ul>
                        </li>
						<li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="ajouter_cat.php">Ajouter des Destination</a>
                                </li>
                                <li>
                                    <a href="sup_cat.php">Supprimer des Destination</a>
                                </li>
                            </ul>
                        </li>
						<li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Supprimer des Categories</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Ajouter les informations sur une Categorie
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action ="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input name="ccode" class="form-control">
                                        </div>
									...
									{
									$code=$_POST['ccode'];
									$sql=mysql_query("delete from Categorie where CODE_CAT =".$code);
									if($sql){echo "bien Supprimer";}else{echo "non Supprimer";}
									}
									?>
                                </div>
                            </div>
