...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Supprimer des Evenements</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                           Ajouter les informations sur un Evenement
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
									...
									{
									$code=$_POST['acode'];
									$sql=mysql_query("delete from Evenement where ID_EVENEMENT = ".$code);
