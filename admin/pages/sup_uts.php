...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Supprimer des utilisateurs</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action ="<?php echo $_SERVER['PHP_SELF']?>" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="acode" class="form-control">
                                        </div>
									...
									$code=$_POST['acode'];
									echo $code;
									$sql=mysql_query("delete from utilisateur where EMAIL_UTILI =".$code);
									if($sql)
									    {
										echo "bien Supprimer";
										}
