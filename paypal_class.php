...
class paypal_class {
	...
	public function submit_paypal_post() {
		...
		$paypal_url = 1 ? SSL_SAND_URL : SSL_P_URL;
		echo "<html>\n";
		echo "<head><title>Patienter ...</title></head>\n";
		echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
		echo "<hr></br></br></br>";
		echo "<center><h2>S'il vous plait patienter, votre commande est traitee et vous";
		echo " serez redirige vers le site de paypal.</h2></center>\n";
		...
		echo "<center><br/><br/>Si vous n'etes pas automatiquement redirige vers ";
		echo "le site de paypal dans les 5 secondes ...<br/><br/>\n";
		echo "</br>";
		echo "<input type=\"submit\" value=\"Click Ici\"></center>\n";
		echo "</form>\n";
		echo "</br><hr>";
		echo "</body></html>\n";
	}
